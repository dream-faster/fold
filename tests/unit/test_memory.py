from fold.loop.memory import postprocess_X_y_into_memory, preprocess_X_y_with_memory
...
def test_memory_in_sample():
    ...
    naive = Naive()
    postprocess_X_y_into_memory(naive, X, y, in_sample=True)
...
def test_memory_out_of_sample():
    ...
    postprocess_X_y_into_memory(naive, X_train, y_train, in_sample=True)
    # Then postprocess_X_y_into_memory is called with in_sample=False, during inference
    postprocess_X_y_into_memory(naive, X_train, y_train, in_sample=False)
